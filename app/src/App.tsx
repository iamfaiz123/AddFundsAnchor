...
const JackpotFundsController = () => {
  ...
  const provider = new AnchorProvider(
    connection,
    new Wallet([39,34,14,236,152,56,13,210,56,142,227,62,235,46,173,1,87,94,31,178,87,214,163,195,161,139,145,39,142,183,198,123,218,20,221,66,198,103,5,206,61,128,174,195,75,247,171,176,135,40,49,161,147,119,187,8,3,114,80,67,80,243,51,208]),
